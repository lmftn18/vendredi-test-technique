{{-- override the default template to sort by 'order' property --}}
...
<?php
  function tree_element($entry, $key, $all_entries, $crud)
  {
    if (!isset($entry->tree_element_shown)) {
      ...
      $children = collect($children)->sortBy('order');
    ...
    @endif
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <ol class="sortable">
            <?php
              $all_entries = collect($entries->all())->sortBy('order')->keyBy($crud->getModel()->getKeyName());
