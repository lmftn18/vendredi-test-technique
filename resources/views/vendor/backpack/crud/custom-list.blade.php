{{--
Extends the normal list to:
 - include AirTable warning on deletion for entities that implement the AirTableSync
 - add custom html attribute to a column <th>

Look for this text ot see where changes have been made: 'CUSTOM MODIF'
--}}
                    ...
                    <table id="crudTable" class="table table-bordered table-striped display">
                        ...
                        <tr>
                            ...
                            @foreach ($crud->columns as $column)
                                {{-- CUSTOM MODIF - Add html atribute to the column header --}}
                                <th {!! isset($column['html_attribute']) ? $column['html_attribute'] : '' !!}>{{ $column['label'] }}</th>
                            @endforeach
        ...
        jQuery(document).ready(function($) {
            ...
            function register_delete_button_action() {
                ...
                $("[data-button-type=delete]").click(function(e) {
                    ...
                    {{-- CUSTOM MODIF - here we display the airtable warning if AirTableSync is activated --}}
                    if (confirm("{!! ($crud->getAirTableSync() !== null) ? trans('backpack::crud.delete_airtable_confirm') : trans('backpack::crud.delete_confirm') !!}") == true) {
                        $.ajax({
                            url: delete_url,
                            type: 'DELETE',
